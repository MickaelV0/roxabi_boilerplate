...
**Parent analysis:** [analyses/280-token-consumption.mdx](280-token-consumption.mdx)
...
4. Writes summary to `plans/{issue}-context.md` in the worktree (prevents context-window eviction between Steps 2 and 5)
5. Step 5 reads `plans/{issue}-context.md` and injects relevant sections into each agent's prompt
