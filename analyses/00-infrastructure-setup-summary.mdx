...
- `analyses/08-cicd-github-actions.md`
- `analyses/09-testing-infrastructure.md`
- `analyses/10-git-hooks.md`
- `analyses/11-documentation-structure.md`
- `analyses/12-claude-code-agents.md`
- `analyses/13-workflow-branching.md`
