...
- **Output:** Analysis document at `analyses/255-token-consumption.mdx` with top 5 consumption hotspots and recommended fixes
...
- **Output:** Analysis document at `analyses/252-taskmaster-evaluation.mdx`
...
- **Output:** Analysis document at `analyses/265-superpowers-evaluation.mdx`
...
- **Output:** Analysis document at `analyses/266-shaping-skills-evaluation.mdx`
...
- **Output:** Spec at `specs/263-shared-task-lists.mdx` → PR with implementation
...
**Output:** `analyses/251-research-synthesis.mdx`
