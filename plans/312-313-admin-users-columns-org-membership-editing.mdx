...
From analyses/312-313-admin-users-columns-org-membership-editing: Both features extend existing Phase 2 admin panel. All data stores and service patterns already exist. ContextMenu added to @repo/ui following DropdownMenu pattern.
