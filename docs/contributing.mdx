...
2. **API** (NestJS) — Render detects the push and deploys
3. GitHub Actions runs CI and reports status on the commit

If something breaks, roll back via the Vercel or Render dashboard. See the [Deployment Guide](/docs/guides/deployment) for details.
