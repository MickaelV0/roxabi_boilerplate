...
.claude/skills/issue-triage/triage.sh set 163 --add-child 164,165
...
.claude/skills/issue-triage/triage.sh set 51 --blocked-by 19
.claude/skills/issue-triage/triage.sh set 19 --blocks 51
```
