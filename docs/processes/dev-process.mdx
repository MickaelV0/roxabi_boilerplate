...
description: Development workflow with three tiers adapted to task complexity
---
...
## Agent Teams (Tier M/L)

For Tier M and L tasks, consider using **Agent Teams** to parallelize work across specialized agents. See the [Agent Teams Guide](/docs/guides/agent-teams) for setup, playbooks, and routing.

**Quick decision:** If your task touches multiple domains (frontend + backend, or code + tests + docs), agent teams will speed things up significantly. Use the [routing decision tree](/docs/guides/agent-teams#2-pick-your-agents) to select agents.
...
cd ../roxabi-web  # or your project folder name
