...
15. Push combined fixes, update PR.
16. CI runs:
...
20. `/promote` creates a PR from staging to main, verifies Vercel preview, and generates a changelog.
21. Human reviews and approves the promotion PR.
22. After merge, run `/promote --finalize` to tag the release and generate release notes.
