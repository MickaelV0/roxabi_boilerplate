...
- `product-analyst` — requirements gathering, acceptance criteria, issue triage
...
Run `/review` on the PR to spawn the **reviewer** agent. It reviews all changes against [code review standards](/docs/standards/code-review) and produces Conventional Comments feedback. Fix any issues raised.
