...
**Configuration:** Each package has its own Vitest config extending the `@repo/config/vitest` module:
...
**Threshold:** Maintain 70% coverage across lines, functions, branches, and statements.
