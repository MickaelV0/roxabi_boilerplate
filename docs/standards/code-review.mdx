...
- [ ] React Compiler enabled — no manual `React.memo` / `useMemo` / `useCallback` unless profiling proves necessary
...
- [ ] Follows module structure (see [frontend-patterns](/docs/standards/frontend-patterns) / [backend-patterns](/docs/standards/backend-patterns))
