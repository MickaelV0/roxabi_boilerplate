...
flowchart TD
    ...
    W --> W1["1. ignoreCommand check\n(is this main? did @repo/web change?)"]
    W1 --> W2["2. bun install"]
    W2 --> W3["3. turbo run build"]
    W3 --> W4["4. Deploy SSR app"]

    A --> A1["1. ignoreCommand check\n(is this main? did @repo/api change?)"]
    A1 --> A2["2. bun install"]
    A2 --> A3["3. bun run db:migrate\n(Drizzle applies pending migrations)"]
