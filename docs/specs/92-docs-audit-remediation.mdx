...
# #92 — Fix Stale Docs and Add Missing Guides

## Context

The [2026-02-09 project audit](/docs/analyses/project-audit-2026-02-09) identified six documentation findings (M-20 through M-25). Two have already been fixed (M-20 JWT_SECRET, M-21 Swagger URL) in commit `67c8894`. Four remain open.

**Promoted from:** [Documentation Audit Remediation Analysis](/docs/analyses/92-docs-audit-remediation)
