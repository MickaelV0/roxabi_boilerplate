...
# #78 — Agent Teams Architecture (Multi-Agent Swarm)
...
| `infra-ops` | inherit | yellow | Read, Write, Edit, Glob, Grep, Bash | `packages/config`, root configs |
...
| `infra-ops` | `docs/configuration.mdx` |
