---
title: Documentation Server - Fumadocs Implementation
description: Technical specification for implementing Fumadocs as the documentation server for Roxabi Boilerplate
---
