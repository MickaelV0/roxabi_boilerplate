...
**Current state:**
- `docs/specs/index.mdx` lists only 1 spec ("Documentation Server") but 18 specs exist.
- `docs/analyses/index.mdx` lists only the original 6 infrastructure analyses but 20+ analyses exist.
...
- [ ] L-6: Both `docs/specs/index.mdx` and `docs/analyses/index.mdx` list all existing documents
