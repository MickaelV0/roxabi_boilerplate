...
| **product-analyst** | purple | Requirements, triage, prioritization | [Issue Management](/docs/processes/issue-management) |
...
| `plan` | Agent can only read and analyze — it proposes changes but cannot execute them | reviewer, security-auditor, architect, product-analyst |
...
| `20` | Architect, product-analyst (analysis-focused) |
...
| product-analyst | `interview`, `issue-triage`, `issues` | Requirements gathering, issue triage, and backlog view |
...
```bash
/bootstrap
# Spawns: product-analyst, architect, doc-writer
...
**As the lead, you:**
1. Run `/bootstrap` — product-analyst gathers requirements, architect designs the system, doc-writer drafts the spec
