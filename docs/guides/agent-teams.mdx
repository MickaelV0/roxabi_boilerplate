...
|-------|-------|------|-----------|
| **fixer** | magenta | Fullstack quick fixer — applies accepted review comments. Spawned in parallel (one per domain) when fixes span multiple domains. | [Code Review](/docs/standards/code-review) |
