...
|-------|-------|------|-----------|
| **fixer** | magenta | Fullstack quick fixer — applies accepted review comments across FE + BE + tests + config | [Code Review](/docs/standards/code-review) |
...
6. Accepted findings are sent to the **fixer** agent, which applies fixes across the stack
7. Fixer commits, pushes, and CI runs
...
```
[fixer: Fix accepted comments across stack]
        |
