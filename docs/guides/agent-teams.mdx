...
| **devops** | yellow | `packages/config/`, root configs | [Configuration](../../configuration) |
...
| Agent | Skill | Purpose |
|-------|-------|---------|
| frontend-dev | `commit`, `context7`, `frontend-design` | Conventional Commits + library docs + UI design |
| backend-dev, devops | `commit`, `context7` | Conventional Commits + library docs |
...
```bash
/teammates add architect frontend-dev backend-dev devops tester doc-writer
