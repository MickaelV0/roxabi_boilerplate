...
For the full design rationale, see the Multi-tenant RLS analysis at `analyses/21-multi-tenant-rls.mdx`.
...
- Multi-tenant RLS analysis (`analyses/21-multi-tenant-rls.mdx`) -- Full design rationale and architectural decisions
