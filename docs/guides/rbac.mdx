...
For the full design rationale, see the RBAC analysis at `analyses/24-rbac.mdx`.
...
- RBAC analysis (`analyses/24-rbac.mdx`) -- Full design rationale and architectural decisions
