...
# #68 Auth UI/UX (Login, Register, Reset, Org pages)
...
**Related documents:**
- [Analysis: #19 Auth + Users](/docs/analyses/19-auth-users) — backend research
- [Spec: #19 Auth + Users](/docs/specs/19-auth-users) — backend implementation spec
