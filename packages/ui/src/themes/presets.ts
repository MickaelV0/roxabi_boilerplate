...
import type { DerivedTheme, ThemeConfig } from '../lib/theme'
...
// ---------------------------------------------------------------------------
// Zinc base (complete variable set — used to fill in partial color presets)
// ---------------------------------------------------------------------------

const ZINC_BASE: ShadcnPreset['cssVars'] = {
  light: {
...
// ---------------------------------------------------------------------------
// Base presets (4 — complete CSS variable sets)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Color presets (17 — partial, merged onto Zinc base)
// ---------------------------------------------------------------------------

export const COLOR_PRESETS: ShadcnPreset[] = [
  {
    name: 'amber',
    title: 'Amber',
    group: 'color',
