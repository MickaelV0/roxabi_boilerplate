...
import { BRAND_COLOR, EmailLayout } from '../components/layout'
...
export function ResetPasswordEmail({ url, translations, locale }: ResetPasswordEmailProps) {
  return (
    <EmailLayout preview={translations.subject} locale={locale}>
